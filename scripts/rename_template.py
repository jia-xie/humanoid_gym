...
It renames all the occurrences of trace_humanoid (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the trace_humanoid folder
        os.rename(
            os.path.join(root_dir_path, "exts", "trace_humanoid", "trace_humanoid"),
            os.path.join(root_dir_path, "exts", "trace_humanoid", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "trace_humanoid"), os.path.join(root_dir_path, "exts", new_name))
